...
// résultat users
                         ...
                         <div class="tweet">
                          ...
                          <?= $this->Html->image('/img/avatar/'.$resultat_users->username.'.jpg', array('alt' => 'image utilisateur', 'class'=>'img-circle vcenter')) ?>
...
<?php
              if(isset($authName))
              {
               if($resultat_users->username != $authName) // si ce n'est pas moi, on vérifie si je suis le résultat de recherche
               {
                ...
                echo $this->cell('Abonnement::test_abo_search', ['authname' => $authName, 'suivi' =>$resultat_users->username]) ;  
               }
             }
             echo '<br />';
...
<?php
            ...
            <div class="tweet">
                ...
                <span class="nb_like"><span class="glyphicon glyphicon-heart" style="vertical-align:center"></span><a href="" data-idtweet="<?= $resultat_tweet->id ;?>" data-toggle="modal" data-target="#viewlike" data-remote="false" onclick="return false;"><span id="compteur_like-<?= $resultat_tweet->id ;?>"> <?= $resultat_tweet->nb_like ;?></span></a>
                  </span>

                <span class="nb_comm_share"><span class="profilnbcomm_<?= $resultat_tweet->id_tweet ;?>"><?= $resultat_tweet->nb_commentaire ?></span> commentaire(s) - <?= $resultat_tweet->nb_partage ?> partage(s)</span>
                <br />
                <br />
