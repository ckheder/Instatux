...
?>
<div class="col-sm-6">
 <h3>Résultat dans les membres pour "<?= $search ?>"</h3>
...
<?= $this->Html->link($resultat_users->username,'/'.$resultat_users->username.'') ?>
               <?= $this->Text->autoParagraph($resultat_users->description) ?>
              </div>
            <?php endforeach; ?>
<h3>Résultat dans les tweets pour "<?= $search ?>"</h3>
...
<?php
            ...
            <div class="tweet">
            	...
            	<?= $this->Html->link($resultat_tweet->user->username,'/'.$resultat_tweet->user->username.'') ?>
                                      <?php
