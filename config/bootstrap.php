...
/* partie de chargement des évèneemnts */
/* évènement nouveau comm */
$CommentaireListener = new CommentaireListener();
EventManager::instance()->attach($CommentaireListener);
/* évènement abonnement */
$AbonnementListener = new AbonnementListener();
EventManager::instance()->attach($AbonnementListener);
/* évènement message */
